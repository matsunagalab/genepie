...
module trj_c_mod
  ...
  public :: trj_analysis_zerocopy_full_com_c
...
contains
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    trj_analysis_zerocopy_full_com_c
  !> @brief        Trajectory analysis with COM (full zerocopy C interface)
  !! @authors      Claude Code
  !! @note         All result arrays are pre-allocated by Python
  !
  !======1=========2=========3=========4=========5=========6=========7=========8

  subroutine trj_analysis_zerocopy_full_com_c(mass_ptr, n_atoms, &
                                              s_trajes_c, ana_period, &
                                              dist_list_ptr, n_dist, &
                                              angl_list_ptr, n_angl, &
                                              tors_list_ptr, n_tors, &
                                              ...
                                              nstru_out, status, msg, msglen) &
        bind(C, name="trj_analysis_zerocopy_full_com_c")
    implicit none
    ...
    ! Run analysis
    write(MsgOut,'(A)') '[STEP1] Trajectory Analysis with COM (full zerocopy)'
    write(MsgOut,'(A)') ' '

    call analyze_zerocopy_full_com(mass_f, s_trajes_c, ana_period, &
                                   dist_list_copy, n_dist, &
                                   angl_list_copy, n_angl, &
                                   tors_list_copy, n_tors, &
                                   cdis_atoms_copy, cdis_offsets_copy, cdis_pairs_copy, &
  ...
  end subroutine trj_analysis_zerocopy_full_com_c
